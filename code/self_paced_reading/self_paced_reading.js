...
For the initial consent screen I am using a button response, as per the grammaticality judgments
code - I like a button response here because I think it makes it less likely that people will keypress
through before they realise what they are supposed to be doing.

For the instruction screen I am using keyboard response as per the grammaticality judgments
code. Note that jsPsych provides an instructions plugin (https://www.jspsych.org/plugins/jspsych-instructions/)
...
var final_screen = {
  ...
  <p>Press any key to finish the experiment and see your raw data.</p>"}
